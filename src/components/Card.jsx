...
function GroupExample() {
  return (
    <CardGroup className="cardgroup">
      <Card>
        <Card.Img id="imgcard" variant="top" src="./images/portofolio/fresh-food.jpg" />
        <Card.Body>
          <h5>Fresh food</h5>
      ...
      <Card>
        <Card.Img id="imgcard" variant="top" src="./images/portfolio/restaurant-japonais.jpg" />
        <Card.Body>
      ...
      <Card>
        <Card.Img id="imgcard" variant="top" src="./images/portfolio/espace-bien-etre.jpg" />
        <Card.Body>
