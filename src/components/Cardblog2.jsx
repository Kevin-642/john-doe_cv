...
function GroupExample() {
  return (
    <CardGroup>
      <Card>
        <Card.Img id="imgcard" variant="top" src="./images/blog/screens.jpg" />
        <Card.Body>
      ...
      <Card>
        <Card.Img id="imgcard" variant="top" src="./images/blog/seo.jpg" />
        <Card.Body>
      ...
      <Card>
        <Card.Img id="imgcard" variant="top" src="./images/blog/technos.png" />
        <Card.Body>
